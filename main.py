...
def visualize_pdb_with_ligand(pdb_path, selected_ligand_id=None):
    ...
    return view
# ==================================================
# ADD THESE TWO FUNCTIONS AFTER visualize_pdb_with_ligand()
# ==================================================
...
def pocket_physics_explainer():
    ...
    with st.expander("Explain Pocket Physics Features"):

        st.markdown("""
### Pocket Radius (Rg)
Radius of gyration measures how widely pocket atoms are distributed around the pocket center.

Formula:

Rg = √( Σ (ri − rcenter)² / N )

Smaller Rg → compact pocket  
Larger Rg → wide pocket

---

### Curvature Score
Pocket curvature is calculated using the **eigenvalues of the covariance matrix** of pocket atom coordinates.

Curvature = λ_min / λ_max

Flat pocket → curvature near 0  
Deep pocket → curvature closer to 1

---

### Phosphate Sites
These correspond to negatively charged **RNA backbone oxygens**:

OP1  
OP2  
O1P

These atoms strongly contribute to **electrostatic interactions with ligands**.
...
These atoms can form **hydrogen bonds** with ligands.

---

### Why These Features Matter
RNALigVS integrates five physics principles:
...
# ==================================================
# MODIFY VISUALIZATION SECTION (ADDITION ONLY)
# ==================================================

# Locate this section in your analysis page:
...
# ==================================================
# ADD EXPLANATION BELOW POCKET METRICS
# ==================================================
