...
if page == "🏠 Home":
    ...
    It predicts binding probability using:
    - Contact density  
    ...
    ### ⚡ Key Features
    - Fast screening of large ligand libraries  
    - Physics-based scoring  
    - No docking required  
    - Interpretable features  
    
    ---
    👉 Use **Run Prediction** to start screening.
    """)
...
# ===============================
    ...
    Upload a `.pdb` file containing RNA.

    ### Step 2: Upload Ligand Library
    Provide SMILES in:
    - TXT (one per line)
    - CSV (first column = SMILES)

    ### Step 3: Run Screening
    Click **Run Virtual Screening**.

    ### Output:
    - Ranked ligands (probability-based)
    - Feature dataset (for analysis)

    ---
    ### Interpretation
    - Probability close to **1 → strong binder**
    - Lower values → weaker interaction
    """)
